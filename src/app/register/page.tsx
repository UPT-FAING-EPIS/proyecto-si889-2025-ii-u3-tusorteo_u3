  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 relative overflow-hidden px-4 py-8">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-pink-500/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-1/3 left-1/2 w-80 h-80 bg-emerald-500/5 rounded-full blur-3xl animate-pulse"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Link href="/" className="flex items-center justify-center mb-8 group">
          <img 
            src="/logo.png" 
            alt="Logo tusorteo" 
            className="w-48 h-auto sm:w-50 md:w-53 group-hover:scale-105 transition-transform duration-300" 
          />
        </Link>
        ...
        <div className="bg-neutral-900 bg-opacity-80 border border-neutral-700/50 backdrop-blur-lg rounded-2xl shadow-2xl p-6 sm:p-10 transition-all duration-300 hover:border-purple-700/50">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm sm:text-base">
              Únete y comienza a crear sorteos increíbles
            </p>
          </div>
